...
export const getAuthState = (rootState: {[AUTH_FEATURE_KEY]: AuthState}): AuthState =>
...
export const selectAuthLoadingStatus = createSelector(getAuthState, x => x.loadingStatus);
